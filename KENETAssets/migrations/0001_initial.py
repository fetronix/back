    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('instore', 'In Store'), ('faulty', 'Faulty'), ('onsite', 'On Site'), ('faulty', 'Faulty'), ('decommissioned', 'Decommissioned'), ('pending_release', 'Pending Release'), ('pending_approval', 'Pending Approval '), ('approved', 'Approved by Admin '), ('rejected', 'Denied by Admin ')], default='instore', max_length=20, null=True)),
            ],
            options={
                'verbose_name': 'Asset',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verifier_user', models.CharField(blank=True, max_length=255, null=True)),
